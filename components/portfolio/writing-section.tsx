...
export default function WritingSection({ onSubPageChange, variant = 'full', initialSlug, initialWritings }: { onSubPageChange?: (v: boolean) => void; variant?: 'home' | 'full'; initialSlug?: string; initialWritings?: Writing[] }) {
  ...
  if (selectedWriting) {
    ...
    return (
      ...
      <div id="top" className="w-full min-h-screen max-w-[920px] mx-auto px-5 sm:px-8 pt-[84px] pb-12 md:pb-20" style={{ animation: 'articleEntrance 0.35s cubic-bezier(0.22,1,0.36,1) both' }}>
